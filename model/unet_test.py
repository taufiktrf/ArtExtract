...
import torch
from block.segtransformer import mit_b1
...
class STUNet(nn.Module):
    def __init__(self):
        ...
        self.decoder_conv2 = Block2(640, 320)  # Concatenating with x3, so 320 + 320
        self.decoder_conv2_1 = Block2(320, 320)
        
        self.decoder_upsample3 = nn.ConvTranspose2d(320, 128, kernel_size=2, stride=2)  # Match the spatial dimensions with x2
        self.decoder_conv3 = Block2(256, 128)  # Concatenating with x2, so 128 + 128
        self.decoder_conv3_1 = Block2(128, 128)
        
        self.decoder_upsample4 = nn.ConvTranspose2d(128, 64, kernel_size=2, stride=2)  # Match the spatial dimensions with x1
        self.decoder_conv4 = Block2(128, 64)  # Concatenating with x1, so 64 + 64
        self.decoder_conv4_1 = Block2(64, 64)
...
from block.sert import SERT


class SERT_decode(nn.Module):
    def __init__(self):
        super(SERT_decode, self).__init__()
